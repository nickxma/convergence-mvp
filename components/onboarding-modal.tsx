...
const STEPS = [
  {
    ...
    icon: (
      <svg aria-hidden="true" className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.2}>
    ...
    >
      ...
      >
        ...
        <div className="px-6 py-8 text-center">
          <div className="flex justify-center mb-5" style={{ color: '#7d8c6e' }} aria-hidden="true">
            {current.icon}
          </div>
          <h2 id="onboarding-title" className="text-base font-semibold mb-3" style={{ color: '#3d4f38' }}>
            {current.title}
          </h2>
