...
export const MOCK_POSTS: Post[] = [
  {
    ...
    body: "I've been practicing for about 6 months and keep running into this question in non-dual teachings. When teachers talk about the illusion of the self, are they saying there's literally nothing there, or just that our ordinary sense of being a subject is distorted?",
  ...
  },
  {
    ...
    body: "Several teachers mention pointing-out instructions from the Dzogchen tradition. I've heard about this but haven't experienced it directly. What has been your experience with these types of direct transmissions?",
  ...
  },
  {
    ...
    title: 'Guided apps vs. standalone practice — differences?',
    body: "For those who've been using guided meditation apps alongside their own practice, do you find the guided sessions help or do they create a dependency? I'm wondering if I'm using the guided format as a crutch.",
...
export const MOCK_REPLIES: Reply[] = [
  {
    ...
    body: "The \"no-self\" teaching isn't a metaphysical claim about non-existence — it's more of a phenomenological observation. When you look carefully for the subject, you find there's just experience arising and passing, with no separate \"experiencer\" behind it.",
  ...
  },
  {
    ...
    body: "I had the same question. The key distinction for me was between the self as a narrative construct (the story you tell about yourself over time) vs. the felt sense of being a subject right now. Most non-dual teachers are pointing at the latter as an illusion.",
  ...
  },
  {
    ...
    body: "Advaita Vedanta calls this the witness — the sense that there's a self watching experience. The pointing-out instruction is meant to collapse that division, showing that the witness and what's being witnessed aren't separate. The secular framing of this insight is essentially the same realization.",
...
export const MOCK_GOVERNANCE_DATA: GovernanceData = {
  ...
  topPosts: [
    ...
    { id: 'mock-5', authorWallet: '0xfeed1234567890abcdefffeed1234567890abcde', title: 'Guided apps vs. standalone practice — differences?', votes: 14 },
    ...
    { id: 'mock-7', authorWallet: '0x112233445566778899aabbccddeeff0011223344', title: 'Psychedelics vs. meditation — comparing insights', votes: 9 },
